  ...
  factory: (require) => {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement('span', { className: 'dsh-goal-icon' }, React.createElement(IconTarget, { size: 14 })),
            React.createElement('span', { className: 'dsh-goal-label' }, `${t('goalLabel') || 'Цель'}:`),
    ...
    const LOCALES = {
      ru: {
        ...
        pluginDesc: 'Панель цели в шапке, декомпозиция вех и авто-драйв',
      ...
      en: {
        ...
        pluginDesc: 'Goal banner in header utilities, milestone decomposition, and auto-drive',
    ...
    module.exports.apply = function apply(ctx) {
      ...
      // 1. Регистрация виджета цели в слот утилит шапки сессии (rc.1)
      registerSlotSafe(
      ...
      // Фоллбек для conversation.header.utilities
      registerSlotSafe(
        'conversation.header.utilities',
        {
          name: 'conversation.header.utilities',
          id: '@goodandready/dsh-goal:utilities',
          order: 10,
          locale: NS,
          inject: () => ({ ctx }),
        },
